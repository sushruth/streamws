declare module "streamws" {
    ...
    module WebSocket {
        export interface IServerOptions {
            ...
            port?: number;
            server?: http.Server;
            verifyClient?: ((info: { origin: string; secure: boolean; req: http.ServerRequest }, callback: (res: boolean) => void) => void) | ((info: { origin: string; secure: boolean; req: http.ServerRequest }) => boolean);
            handleProtocols?: any;
            path?: string;
            noServer?: boolean;
        ...
        export class Server extends events.EventEmitter {
            ...
            close(): void;
            handleUpgrade(request: http.ServerRequest, socket: net.Socket, upgradeHead: Buffer, callback: (client: WebSocket) => void): void;
